...
class SearchTrainRouter: PresenterToRouterProtocol {
    ...
    static func navigateToAddFavourite(data: [Station]) -> AddFavoiriteViewController {
        let view = mainstoryboard.instantiateViewController(withIdentifier: "AddFavoiriteViewController") as! AddFavoiriteViewController
        view.station = data
        return view
